          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('productos.update', $item->id)}}" method="POST" >
                ...
                <input type="text" class="form-control" name="codigo" id="codigo" required value="{{ $item->codigo }}">
                <label for="nombre">Nombre del producto</label>
                <input type="text" class="form-control" name="nombre" id="nombre" required value="{{ $item->nombre }}">
                <label for="descripcion">Descripcion</label>
                <textarea class="form-control" name="descripcion" id="descripcion" rows="3">{{$item->descripcion}} </textarea>
                <label for="precio_venta">Precio de venta</label>
                <input type="text" class="form-control" name="precio_venta" id="precio_venta" required value="{{ $item->precio_venta }}">
