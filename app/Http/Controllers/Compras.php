...
class Compras extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('modules.compras.create', compact('item', 'titulo'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return to_route('productos')->with('success', 'Compra realizada con éxito!');
        } catch (\Throwable $th) {
            return to_route('productos')->with('error', 'Hubo un error al realizar la compra!'.$th->getMessage());            
        }
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return to_route('compras')->with('error', 'Hubo un error al actualizar la compra!'.$th->getMessage());
        }
    }
    ...
    public function destroy(string $id, Request $request)
    {
        try {
            ...
            if ($item->delete()) {
                ...
                return to_route('compras')->with('error', 'No se pudo eliminar la compra!');
            }
        } catch (\Throwable $th) {
            return to_route('compras')->with('error', 'Hubo un error al eliminar la compra!'.$th->getMessage());
        }
    }
}
