...
class Productos extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('modules.productos.edit', compact('titulo', 'categorias', 'proveedores', 'item'));
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            $item->save();
            return to_route('productos')->with('success', 'Producto editado correctamente!!!');
        } catch (\Throwable $th) {
            return to_route('productos', $id)->with('error', 'Error al editar el producto!!!' . $th->getMessage());
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            $item = Producto::find($id);
            $item->delete();
            return to_route('productos')->with('success', 'Producto eliminado correctamente!!!');
        } catch (\Throwable $th) {
            return to_route('productos')->with('error', 'Error al eliminar el producto!!!' . $th->getMessage());
        }
    }
    ...
    public function update_image(Request $request, $id) 
    {
        try {
            ...
            $item->nombre = $nombreImagen;
            $item->save();
            return to_route('productos')->with('success', 'Imagen del producto editada correctamente!!!');
        } catch (\Throwable $th) {
            return to_route('productos')->with('error', 'Error al editar la imagen del producto!!!' . $th->getMessage());
        }
    }
