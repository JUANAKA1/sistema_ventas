...
class Proveedores extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $item->save();
            return to_route('proveedores')->with("success", "Proveedor agregardo con exito!!!");
        } catch (\Throwable $th) {
            return to_route('proveedores')->with("error", "Hubo un error al agregar el proveedor. ". $th->getMessage());
        }
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return to_route('proveedores')->with("error", "Hubo un error al actualizar el proveedor. ". $th->getMessage());
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return to_route('proveedores')->with("error", "Hubo un error al eliminar el proveedor. ". $th->getMessage());
                }
    }
}
